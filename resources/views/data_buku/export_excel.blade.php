...
{{-- <table>
    <tbody>
        <tr>
            <td colspan="9" style="font-weight:bold;text-align:center">Export Excel</td>
        </tr>
        <tr>
...
<table>
    ...
    <tr>
        ...
        <th style="font-weight:bold;text-align:center;background:#f4f4f4;border:1px solid #000000;">Tahun_Terbit</th> <!-- kolom E -->
